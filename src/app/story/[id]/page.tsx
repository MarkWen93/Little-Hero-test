    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-blue-100 to-blue-50 px-4 py-8">
      <div className="container max-w-2xl text-center">
        ...
        <p className="mb-12 text-xl text-gray-700">
          We're crafting a magical adventure just for you...
        </p>
        ...
        <p className="mb-8 text-xl text-gray-700">
          Your {adventureId.split('-').join(' ')} story is being created...
        </p>

        <div className="mt-8 flex justify-center">
          <Button asChild variant="secondary" size="lg">
            <Link href="/create/adventure">← Choose Another Adventure</Link>
          </Button>
        </div>
      </div>
    </main>
